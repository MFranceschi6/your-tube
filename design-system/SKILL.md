...
description: Use this skill to generate well-branded interfaces and assets for YourTube, a personal YouTube audio player mobile app (Android + iOS). Contains essential design guidelines, colors, type, tokens, and UI kit components for prototyping both platforms.
user-invocable: true
---
